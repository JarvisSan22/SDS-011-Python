...
def createdir(dirname):
    ...
    #create inital plots folder
    if not  os.path.exists("Plots"):
        os.mkdir("Plots")
        print("新しいPlotsのDIRを使いた")
        
#CREATE NEW DIR FOR THE DATA 
...
def ploter(Datas,Cols,Dates,filename,infos,ave):
    ...
    for var in Cols:
        ...
        if var.upper()=="STATICMAP":
            ...
            titlename="Plots//"+locname+filename+'-'+var #save name 
            AQMap.genmap(Datas,"pm2.5",titlename,infos,locname)
